...
#ifndef FEATUREVIDEO_SWIFT_H
#define FEATUREVIDEO_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="FeatureVideo",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC12FeatureVideo17CachingPlayerItem")
...
SWIFT_CLASS("_TtC12FeatureVideo21FeatureVideoResources")
@interface FeatureVideoResources : NSObject
