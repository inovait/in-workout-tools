    ...
    private func _reduce(into state: inout State, action: Action.ViewAction) -> Effect<Action> {
        ...
        case .root(.home(.delegate(let actionDelegate))):
            ...
            case .openFreeWorkout:
                let exercise: RepsExercise = .init(id: UUID().uuidString, name: "Free Workout", type: .exercise, durationInMillis: 0, idx: 0, exerciseRepetition: 0, reps: 0, loopSubExercises: false, canSkipExercise: false, subExercises: [])
            ...
            case .openTempView:
                state.path.append(.workout(.init(exercise: RepsExercise(id: "w1d1", name: "W1D1: Sweaty Emom", type: .exercise, durationInMillis: 16 * 60 * 1000, idx: 0, exerciseRepetition: 0, reps: 0, loopSubExercises: true, canSkipExercise: false, subExercises: [
                ...
                return .none
//                state.path.append(.workoutHandler(RepsExercise(id: "w1d1", name: "W1D1: Sweaty Emom", type: .exercise, durationInMillis: 16 * 60 * 1000, idx: 0, exerciseRepetition: 0, reps: 0, loopSubExercises: true, canSkipExercise: false, subExercises: [
//                    RepsExercise(id: "pushup", name: "Push-Ups", type: .exercise, durationInMillis: 60 * 1000, idx: 1, exerciseRepetition: 0, reps: 10, loopSubExercises: false, canSkipExercise: false, subExercises: [], media: media[0]),
//                    RepsExercise(id: "squats", name: "Squats", type: .exercise, durationInMillis: 60 * 1000, idx: 2, exerciseRepetition: 0, reps: 15, loopSubExercises: false, canSkipExercise: false, subExercises: [], media: media[1]),
//                    RepsExercise(id: "bicycle", name: "Bicycle Crunches", type: .exercise, durationInMillis: 60 * 1000, idx: 3, exerciseRepetition: 0, reps: 15, loopSubExercises: false, canSkipExercise: false, subExercises: [], media: media[2]),
//                    RepsExercise(id: "inAndOut", name: "In And Out Jumps", type: .exercise, durationInMillis: 60 * 1000, idx: 4, exerciseRepetition: 0, reps: 10, loopSubExercises: false, canSkipExercise: false, subExercises: [], media: media[3])
